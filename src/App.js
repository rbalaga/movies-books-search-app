...
const gitHubUrl = '/data/data.json'; // https://hubspotwebteam.github.io/CodeExercise/src/js/data/data.json";
  ...
  const getFilteredMedias = () => {
    let filteredMedia =
      selectedGenres.length > 0
        ? userData.filter((media) => checkGeneres(selectedGenres, media.genre))
        : userData;
    filteredMedia =
